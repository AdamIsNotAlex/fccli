...
| DET-MUTUAL-EXCLUSION | REQUIRED | PASS | `cargo check --locked --all-targets --no-default-features --features test-transport,production-transport`; expected nonzero only from dedicated feature-conflict `compile_error!` | never |
